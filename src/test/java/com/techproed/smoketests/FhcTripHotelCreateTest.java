...
public class FhcTripHotelCreateTest extends TestBase {
    ...
    public void test() throws InterruptedException {
        ...
        createPage.codeKutusu.sendKeys("Rumi");
        createPage.nameKutusu.sendKeys("Anadolu");
        createPage.phoneKutusu.sendKeys("0673937393");
        createPage.adressKutusu.sendKeys("Blois/France");
        createPage.emailKutusu.sendKeys("anadolurumi@gmail.com");
